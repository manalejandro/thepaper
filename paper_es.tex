...
% =============================================================================
\section{Mecánica Celeste: El Lenguaje Matemático del Movimiento}
% =============================================================================
...
% =============================================================================
\section{La Ecuación del Cohete: El Precio de la Energía Cinética}
% =============================================================================
...
angular de la ingeniería de cohetes. El impulso específico $I_{\mathrm{sp}} = v_e/g_0$
(en segundos) es la figura de mérito de cualquier sistema propulsivo.

\subsection{El Problema de la Fracción de Masa}

La relación de masa necesaria para un $\Delta v$ dado:
\begin{equation}
  \frac{m_0}{m_f} = \exp\!\left(\frac{\Delta v}{v_e}\right),
\end{equation}
crece exponencialmente con $\Delta v$, lo que hace que la propulsión química
sea categoricamente inviable para viajes interestelares.
...
de radios $r_1$ y $r_2$ es la \emph{transferencia de Hohmann}. Los impulsos
necesarios son:
\begin{align}
...
El Proyecto Orion propuso detonar bombas nucleares tras una placa de empuje.
...
\begin{equation}
  ...
  I_{\mathrm{sp,\,máx}} = \frac{c}{g_0} \approx \SI{3{,}06e7}{\second}.
\end{equation}
...
especial de Einstein (1905) introduce el factor de Lorentz:
\begin{equation}
...
El análogo relativista de la ecuación de Tsiolkovsky es:
\begin{equation}
...
\end{align}
donde $\tau$ es el tiempo propio del viajero. Para $a = g = \SI{9{,}81}{\meter\per\second\squared}$:
\begin{itemize}[noitemsep]
  \item Marte (0{,}52\,UA): tiempo de viaje $\approx 63$ días, igual para ambos sistemas.
  \item Próxima Centauri (4{,}24 años-luz): tiempo propio $\approx 3{,}5$ años frente a $5{,}9$ años coordinados.
  \item Centro Galáctico (26\,000 años-luz): el viajero envejece solo 21 años,
    pero en la Tierra transcurren 52\,026 años.
\end{itemize}
...
Láctea? Frank Drake propuso en 1961:
\begin{equation}
...
\end{itemize}
Generalización continua: $K = (\log_{10} P_W - 6)/10$.
En 2026, la humanidad consume $\sim \SI{2e13}{\watt}$, situándose en $K \approx 0{,}73$.

% =============================================================================
\section{Comunicación a Través de las Distancias Interestelares}
% =============================================================================
...
El teorema de la capacidad del canal de Shannon:
\begin{equation}
...
interpretación por cualquier inteligencia tecnológica.

\subsection{La Propuesta Lincos y la Codificación por Números Primos}

Hans Freudenthal (1960) propuso construir un lenguaje interestelar desde
...
% =============================================================================
\section{Estableciendo Relaciones Interestelares: Diplomacia a Través del Vacío}
% =============================================================================
